...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\AdminBundle\\Controller\\AdminController' => 'getAdminControllerService.php',
            'App\\GeneralBundle\\Controller\\GeneralController' => 'getGeneralControllerService.php',
            'App\\LoginBundle\\Controller\\LoginController' => 'getLoginControllerService.php',
            'App\\OrderBundle\\Controller\\OrderController' => 'getOrderControllerService.php',
            ...
            'email_service' => 'getEmailServiceService.php',
            'encrypt_decrypt' => 'getEncryptDecryptService.php',
            'filesystem' => 'getFilesystemService.php',
            'form.factory' => 'getForm_FactoryService.php',
            'general_webservice' => 'getGeneralWebserviceService.php',
            'knp_snappy.image' => 'getKnpSnappy_ImageService.php',
            'knp_snappy.pdf' => 'getKnpSnappy_PdfService.php',
            'log_save' => 'getLogSaveService.php',
        ...
        $this->privates['service_container'] = function () {
            include_once $this->targetDirs[3].'\\src\\GeneralBundle\\EventListener\\RequestListener.php';
            ...
            include_once $this->targetDirs[3].'\\src\\TwigsBundle\\Twig\\Extension\\JsonDecode.php';
            include_once $this->targetDirs[3].'\\src\\TwigsBundle\\Twig\\Extension\\ToInt.php';
            include_once $this->targetDirs[3].'\\src\\TwigsBundle\\Twig\\Extension\\ToString.php';
            include_once $this->targetDirs[3].'\\src\\TwigsBundle\\Twig\\Extension\\encryptDecrypt.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zWJtPxTfmX', 0, ($this->targetDirs[0].'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5S0-TRGYDe', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'charset' => 'utf8mb4', 'dbname' => 'genezi', 'host' => 'localhost', 'port' => '', 'user' => 'root', 'password' => '', 'driverOptions' => [], 'serverVersion' => '5.7', 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci']], $a, $d, []);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_0499fc6d0480b497cb7cf770533bf0fbb1b12f5582aa6b5edbe5afb352cc62dc');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['kernel.listener.request_listener'] ?? $this->getKernel_Listener_RequestListenerService());
        }, 1 => 'onKernelRequest'], 0);
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'\\vendor\\symfony\\debug-bundle/Resources/views'), '!Debug');
        $a->addPath(($this->targetDirs[3].'\\src\\TwigsBundle/Resources/views'), 'Twigs');
        $a->addPath(($this->targetDirs[3].'\\src\\TwigsBundle/Resources/views'), '!Twigs');
        $a->addPath(($this->targetDirs[3].'/src/TwigsBundle/Resources/views'));
        $a->addPath(($this->targetDirs[3].'\\vendor\\symfony\\twig-bridge/Resources/views/Form'));

        $this->services['twig'] = $instance = new \Twig\Environment($a, ['default_path' => ($this->targetDirs[3].'/src/TwigsBundle/Resources/views'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception::showAction', 'form_themes' => $this->parameters['twig.form.resources'], 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'paths' => [], 'date' => ['format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL], 'number_format' => ['decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',']]);
        ...
        $instance->addExtension(new \App\TwigsBundle\Twig\Extension\JsonDecode());
        $instance->addExtension(new \App\TwigsBundle\Twig\Extension\ToInt());
        $instance->addExtension(new \App\TwigsBundle\Twig\Extension\ToString());
        $instance->addExtension(new \App\TwigsBundle\Twig\Extension\encryptDecrypt());
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xcyDU8YsJc', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wDzO3uxtqn', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DaBWjHie9M', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3I4qqV61c3', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4Xgs+9r6En', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private 'kernel.listener.request_listener' shared autowired service.
     *
     * @return \App\GeneralBundle\EventListener\RequestListener
     */
    protected function getKernel_Listener_RequestListenerService()
    {
        return $this->privates['kernel.listener.request_listener'] = new \App\GeneralBundle\EventListener\RequestListener($this, ($this->services['session'] ?? $this->getSessionService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['twig'] ?? $this->getTwigService()));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'GeneralBundle' => [
                    'path' => ($this->targetDirs[3].'\\src\\GeneralBundle'),
                    'namespace' => 'App\\GeneralBundle',
                ],
                'LoginBundle' => [
                    'path' => ($this->targetDirs[3].'\\src\\LoginBundle'),
                    'namespace' => 'App\\LoginBundle',
                ],
                'OrderBundle' => [
                    'path' => ($this->targetDirs[3].'\\src\\OrderBundle'),
                    'namespace' => 'App\\OrderBundle',
                ],
                'TwigsBundle' => [
                    'path' => ($this->targetDirs[3].'\\src\\TwigsBundle'),
                    'namespace' => 'App\\TwigsBundle',
                ],
                'KnpSnappyBundle' => [
                    'path' => 'C:/xampp/htdocs/geneziSymReact/vendor/knplabs/knp-snappy-bundle',
            ...
            case 'twig.default_path': $value = ($this->targetDirs[3].'/src/TwigsBundle/Resources/views'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'GeneralBundle' => 'App\\GeneralBundle\\GeneralBundle',
                'LoginBundle' => 'App\\LoginBundle\\LoginBundle',
                'OrderBundle' => 'App\\OrderBundle\\OrderBundle',
                'TwigsBundle' => 'App\\TwigsBundle\\TwigsBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'saas02@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'S3AlAmS383',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.mailer.default.transport.smtp.local_domain' => NULL,
            'swiftmailer.spool.default.memory.path' => 'C:\\wamp\\www\\genezi\\var\\cache\\dev/swiftmailer/spool/default',
            ...
            'knp_snappy.pdf.binary' => 'C:/wkhtmltopdf/bin/wkhtmltopdf',
            ...
            'knp_snappy.image.binary' => 'C:/wkhtmltopdf/bin/wkhtmltoimage',
