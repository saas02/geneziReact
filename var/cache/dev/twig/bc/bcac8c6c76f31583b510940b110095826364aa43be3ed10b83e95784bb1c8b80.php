...
class __TwigTemplate_7655c832a201df42288ab8e222bd8a6992a836146013739cce322e17d7176274 extends Twig_Template
{
    private $source;
...
";
        ...
        ";
            ...
            if (( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["producto"], "inpromo", [])) && (twig_get_attribute($this->env, $this->source, $context["producto"], "inpromo", []) > 0))) {
                ...
                // line 16
                echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (isset($context["precioPromo"]) || array_key_exists("precioPromo", $context) ? $context["precioPromo"] : (function () { throw new Twig_Error_Runtime('Variable "precioPromo" does not exist.', 16, $this->source); })()), 0, ".", ","), "html", null, true);
                echo "</p></font>
                    ";
            } else {
                // line 18
            ...
            echo "                                         
                <p class=\"text-center\">
                    <a href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("detail", ["name" => twig_get_attribute($this->env, $this->source, $context["producto"], "nombreprod", [])]), "html", null, true);
    ...
    ";
            // line 28
            $context["count"] = ((isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new Twig_Error_Runtime('Variable "count" does not exist.', 28, $this->source); })()) + 1);
            // line 29
            echo "    ";
            if ((0 == (isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new Twig_Error_Runtime('Variable "count" does not exist.', 29, $this->source); })()) % (isset($context["filas"]) || array_key_exists("filas", $context) ? $context["filas"] : (function () { throw new Twig_Error_Runtime('Variable "filas" does not exist.', 29, $this->source); })()))) {
                // line 30
...
";
    ...
    {
        return array (  116 => 31,  112 => 30,  109 => 29,  107 => 28,  98 => 22,  94 => 21,  90 => 19,  84 => 18,  79 => 16,  74 => 15,  71 => 14,  69 => 13,  65 => 12,  61 => 11,  53 => 9,  51 => 8,  48 => 7,  42 => 5,  40 => 4,  37 => 3,  33 => 2,  29 => 1,);
    }
    ...
    <div class=\"col-xs-12 col-sm-6 col-md-3\">
        ...
        <div class=\"thumbnail\">                                                                
            ...
            <div class=\"caption\">
                ...
                {% endif %}                                         
                <p class=\"text-center\">
                    <a href=\"{{ path('detail', { 'name' : producto.nombreprod }) }}\" class=\"btn btn-primary btn-sm\" ><i class=\"fa fa-plus\"></i>&nbsp; Detalles</a>&nbsp;&nbsp;
